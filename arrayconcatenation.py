# Two or more arrays can be concatenated together using the concatenate function with a tuple of the arrays
# to be joined:
# import numpy
...
#
# Task
# You are given two integer arrays of size X and X ( & are rows, and is the column). Your
# task is to concatenate the arrays along axis .
# Input Format
